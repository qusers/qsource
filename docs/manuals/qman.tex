...
Carlson,  Peter  Hanspers,  Anders  Kaplan,  Kajsa  Ljunjberg,  Martin
Nervall,  Johan  Sund, Alexandre  Barrozo,  Paul  Bauer, Beat  Amrein,
Masoud Karemi, Irek Szeler, Miha Purg and \AA ke Sandgren. The code is
in active  development and new  features are being  implemented mainly
following   the  fortran   2003   standard.    Additionally  the   MPI
implementation  has  been updated  to  enhance  the speed  of  running
parallel  jobs  and  provide  a  more  robust  parallelization  across
different cluster  architectures.  The  program code is  hosted online
thanks to  a generous github  academic account granted to  the program
developers at Uppsala  University.  Instructions on how  to obtain the
code     can     be     found     online     at     the     Q-website:
...
\textbf{Q}  5.7 can  be compiled  and run  in Windows  7, Mac  OSX and
...
second 1.0 Å, the third 1.5 Å, so the polarization is restrained
