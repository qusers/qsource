...
In   Q    the   thermostat   in    use   at   the   moment    is   the
...
%In  Q  thermostat  (temperature-control) algorithms  can  be  selected
...
%% thermostat in Q  has been implemented in the same  way as it's done
