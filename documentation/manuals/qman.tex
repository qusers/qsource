...
\begin{figure}[h]
\begin{center}
\resizebox{9cm}{!}{\includegraphics[scale=0.9]{\dirfig/qlogo.png}}
\end{center}
\end{figure}
\begin{center}
%\Huge{M}\huge{ANUAL}\\
...
%===============================================================================
\section{PREFACE}
\textbf{Q} started its development sometime in the nineteen nineties originally
...
Alexandre Barrozo, Masoud Karemi, Mauricio Esguerra, Irek Szeler, Miha
Purg and  \AA ke Sandgren. The  code is in active  development and new
features  are  being implemented  mainly  following  the fortran  2003
...
\textbf{Q}ueue of  maybe for \textbf{Q}uantum,  but we would be  a bit
hesitant about that last one.
...
\textbf{Example: Charging a benzene molecule}\\*[0.25cm] 
...
force constant  of 200 kcal$\cdot$mol$^{-1}\cdot$Å$^{-2}$.  All bonded
...
for physical conservation laws. Q provides two options of symplectic 
...
Q comes with the option of choosing the thermostat which the user
judges appropriate. The three thermostats present are
Berendsen\cite{Berendsen:1984}, Nos\'e-Hoover chains\cite{Tuckerman:1992}
 and Langevin\cite{Schneider:1978}. One can change the thermostat
...
\bibitem{Marelius:1998}Marelius J., Graffner-Nordberg M., Hansson T.,
  Hallberg A., Aqvist J., Computation    of    affinity     and
  selectivity:    binding    of 2,4-diaminopteridine   and
  2,4-diaminoquinazoline   inhibitors   to dihydrofolate reductases,
  J. Comput. Aided Mol. Des. 12, J. Comput. Aided Mol. Des. 12,
  119-131, 1998
