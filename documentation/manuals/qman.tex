...
% Q stands for partition function
% Q stands for heat
% Q stands for waiting in Queue
% Q for Quantum? maybe NOT
% 
...
In this case, a harmonic angle force is applied between the atoms 133, 132 and 3400,
 in order to enforce a 180$^{\circ}$, with 3.0 kcal$\cdot $mol$^{-1}\cdot ${degrees}$^{-2}$
at the state 2.
